                ...
                for vpn in segment.page_range().iter() {
                    ...
                    if let Some(init_data) = init_data {
                        if !init_data.is_empty() {
                            ...
                            let src_slice = &init_data[(page_address + start - segment.range.start)..(page_address + stop - segment.range.start)];
